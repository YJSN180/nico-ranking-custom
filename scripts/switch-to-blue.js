...
async function switchToBlue() {
  console.log('🔄 Switching to Blue Worker...\n');

  try {
    // Update active_worker to "blue"
    ...
    console.log('✅ Successfully switched to Blue Worker');
