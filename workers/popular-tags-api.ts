/**
 * Popular Tags API Worker
 * Provides popular tags data from Cloudflare KV with fallback to scraping
 * Migrated from Vercel Functions to reduce costs and improve performance
 */
...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    // Only handle popular-tags endpoint
    if (!url.pathname.startsWith('/api/popular-tags')) {
