 ...
 * 安全なCORSヘッダーを生成
 */
export function createSecureCORSHeaders(origin) {
 ...
 */
export function applyCORSHeaders(response, origin, additionalHeaders = {}) {
 ...
 * CORS設定のデバッグ情報
 */
export function getCORSDebugInfo(origin) {
    return {
        origin: origin,
