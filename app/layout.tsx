    ...
    <html lang="ja" data-theme="light" suppressHydrationWarning>
      <head>
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          [data-testid="ranking-item"]{background:var(--surface-color,#fff);border:1px solid var(--border-color,#e5e5e5);border-radius:8px;overflow:hidden;margin-bottom:8px;padding:0}
